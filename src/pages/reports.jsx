    ...
    try {
      if (role == "1") {
        const response = await axios.get(
          "http://tpbooks5.teleperformance.co/api/cases/all",
          config
        );
        ...
        const response = await axios.get(
          `http://tpbooks5.teleperformance.co/api/cases/clienteid/${clientId}/`,
          config
        );
              ...
              <div className="m-2  ">
                <div className="row" style={{ minHeight: "50px", margin: "0" }}>
                  ...
                  <div
                    ...
                    style={{ height: "3.8rem", padding: "15px" }}
                  >
                    <Button
                      variant="contained"
                      size="small"
