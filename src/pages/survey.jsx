  ...
  const survInfo = async () => {
    ...
    try {
      const response = await axios.post(
        "http://tpbooks5.teleperformance.co/api/cases/create",
        data,
        config
      );
    ...
    <div className="indexBody d-flex align-items-center justify-content-center">
      <div className="contMain pt-4 ps-4 pe-4">
        ...
        <p className="text-white fw-bold fs-5">
          Queremos conocer cómo fue su experiencia con nuestro contenido
          virtual:
        </p>
        <div className="container contSurvey p-4 mt-2 ">
          ...
          <div className="row mt-1 mb-0">
            <div className="col text-end">
              <button className="btn btn-custom" onClick={survInfo}>
                {" "}
                <span className="fw-bold text-white">Enviar</span>
              </button>
            </div>
          </div>
        </div>
